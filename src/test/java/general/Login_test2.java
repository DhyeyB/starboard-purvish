...

{
...

	{
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.EditText[@index='0']")));
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='OK']")));
		...
		//wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.TextView[@text='Login to Starboard']")));

		// Click on magic link
		MobileElement ele = driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().text(\"Login to Starboard\"))"));
		//MobileElement ele = driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"Login to Starboard\").instance(0))"));
		ele.click();
	...
	public void LoginTOApplication() throws Exception {
		...
		WebDriverWait wait = new WebDriverWait(driver, 50);
		  ...
		  // Open Gmail 
		  driver.activateApp("com.google.android.gm");
		  System.out.println("Gmail app Opened");
		  ...
		  "pandyapurvish1708@gmail.com"); driver.hideKeyboard();
